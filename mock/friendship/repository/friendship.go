...
func (m *MockFriendshipRepository) GetFriendshipByUserIDAndStatus(ctx context.Context, userIDs, emails []string, status ...domain.FriendshipStatus) ([]string, error) {
	args := m.Called(ctx, userIDs, emails, status)
